...
# Did the visualisation support their understanding?
...
```{r}
# check assumptions
shapiro.test(fa_scores$Understand) #violated
shapiro.test(fa_scores$Enhance) #violated
ggqqplot(fa_scores$Understand, ylab = "Understand",
         ggtheme = theme_minimal())
ggqqplot(fa_scores$Enhance, ylab = "Understand",
         ggtheme = theme_minimal())

#Therefore you need to conduct the One-Sample Wilcoxon Signed Rank Test in R

#live 
wilcox.test(fa_scores$Understand, mu = 0, alternative = "two.sided")
wilcox.test(fa_scores$Enhance, mu = 0, alternative = "two.sided")
```
...
# check assumptions
shapiro.test(oneSample$Understand) #violated
shapiro.test(oneSample$Enhance) # meets 
ggqqplot(oneSample$Understand, ylab = "Understand",
         ggtheme = theme_minimal())
ggqqplot(oneSample$Enhance, ylab = "Understand",
         ggtheme = theme_minimal())

wilcox.test(oneSample$Understand, mu = 0, alternative = "two.sided")
t.test(oneSample$Enhance, mu = 0, alternative = "two.sided")
```
```{r}
#online first simple

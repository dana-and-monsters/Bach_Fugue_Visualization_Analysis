...
names(cor_data_Bach_nona)<-c("Age", "Empathic Concern","AIMS", "Musical Sophistication", "Fan-status", "Perceive", "Instruments","Understanding", "Augment", "Disturb", "Enhance", "Moved", "Familiar","Style")
...
## Factor Score Kendall Rank Correlations 
...
# title = "Bach Visualization"
subtitle = paste0("Kendall Correlations (BH adj) (n = ", samples, ")")
chart.correlation(fa_scores_and_pers_chars_nona, colours_DSQ, title, subtitle) #moved the cross-correlation code to the useful_functions script to make this more tidy.

graphname<-paste0("../plots/New_Kendall-Correlations", title, ".png")
ggsave(graphname, 
       width = 9, 
       height = 7, 
       units = 'cm', 
